...
namespace aigentforinsurance
{
    public class workflowsactivations
    {
        private readonly ILogger _logger;

        public workflowsactivations(ILogger<workflowsactivations> logger)
        {
            _logger = logger;
        }
